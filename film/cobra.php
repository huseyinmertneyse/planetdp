            ...
            if(!isset($_SESSION['kadi']) && isset($_COOKIE['cookie']))
            {
                ...
                if($say > 0)
                {
                    ...
                    header('Location:../film/cobra.php');
                }
                header('Location:../film/cobra.php');
            }
            ...
            if(isset($_SESSION['kadi']))
            {
                ...
                if(isset($_POST['textarea-button']))
                {
                    ...
                    $kaydet = mysqli_query($baglan,"INSERT INTO yorumlar (filmadi,kadi,yorum) VALUES('Cobra Kai (2018)','$kadi','$textarea')");
                }
                    ...
                    <div class="cont" style="width:1165px;">
                        <div class="icerik"> 
                            <div style="height: 494px;width: 336px;float: left;">
                                ...
                                <img src="../image/cobra.jpg" style="width:100%;height:100%;">
                            </div>
                            <div style="float: left;margin-left:50px;">
                                <a style="text-decoration: none;color:black;" href="../film/cobra.php"><h1>Cobra Kai (2018)</h1></a>
                            </div>
                            <div class="clear"></div>   
                        </div>  
                    </div> 
                            ...
                            <div class="cont" style="width:1165px;">
                                <div class="icerik">
                                    ...
                                    <div style="margin-top: 50px;display:'.$yorumdis.'">
                                        <form action="../film/cobra.php" method="POST">
                                    ...
                                    <div class="clear"></div>';
                                        ...
                                        $yorum = mysqli_query($baglan,"SELECT * FROM yorumlar where filmadi = 'Cobra Kai (2018)' ORDER BY id DESC");
                                            ...
                                            {   
                                                ...
                                                echo '
                                                    ...
                                                    <div style="float:left;margin-left:45px;">
                                                        <a href="../film/cobra.php?like=like&yorumid='.$yorumid.'"><img style="height:13px;width:13px;" src="../image/like-button.png"></a><span style="inline-block;margin:0 5px;">'.$begeni_sayisi.'</span>
                                                        <a href="../film/cobra.php?like=dislike&yorumid='.$yorumid.'"><img style="height:13px;width:13px;" src="../image/dislike-button.png"></a><span style="inline-block;margin:0 5px;">'.$begenmeme_sayisi.'</span>
                                                    </div>
                                                    <div>
                                                        ...
                                                        echo'
                                                        <a href="../begeni.php?yorumid='.$yorumid.'&filmadi=Cobra Kai (2018)" style="visibility:'.$begenenler_link.'; text-decoration: none;font-size:15;font-weight:700;">...</a>
                                                    </div>
                                                    <div class="clear"></div>
                                                        ...
                                                        if($yoruma_yorum_atanlar_control > 0)
                                                        {
                                                            while($yorumlar = mysqli_fetch_array($yoruma_yorum_atanlar))
                                                            {
                                                                ...
                                                                <div style="margin-left:45px;">
                                                                    ...
                                                                    <div class="clear"></div>
                                                                    <div style="float:left;margin-left:45px;">
                                                                        <a href="../film/cobra.php?altyorumlike=like&altyorumid='.$altyorumid.'"><img style="height:13px;width:13px;" src="../image/like-button.png"></a><span style="inline-block;margin:0 5px;">'.$altyorum_begeni_sayisi.'</span>
                                                                        <a href="../film/cobra.php?altyorumlike=dislike&altyorumid='.$altyorumid.'"><img style="height:13px;width:13px;" src="../image/dislike-button.png"></a><span style="inline-block;margin:0 5px;">'.$altyorum_begenmeme_sayisi.'</span>
                                                                    </div>
                                                                    <div>
                                                                        ...
                                                                        echo'
                                                                        <a href="../begeni.php?altyorumid='.$altyorumid.'&filmadi=Cobra Kai (2018)" style="visibility:'.$altyorum_begenenler_link.'; text-decoration: none;font-size:15;font-weight:700;">...</a>
                                                                    </div>
                                                                    <div class="clear"></div>
                                                                </div> 
                                                                ';
                                                    ...
                                                    <div style="float:left; margin-top:5px; display: none;margin-left:45px;" name="'.$yorumid.'">
                                                        <form action="../film/cobra.php?yorumid='.$yorumid.'" method="POST">
                    ...
                    <div class="cont">
                        <div class="pencere-ort">
                            <div style="padding: 0 20px;">
                                <a class="pencere-kapa" href="../film/cobra.php"></a>
