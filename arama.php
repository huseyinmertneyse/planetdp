        ...
        <div class="cont" style="width:1165px;">
            <div class="icerik">
                <div class="sol">
                    ...
                    {
                        $cumle = $_GET['arama'];
                        $film_sorgu = mysqli_query($baglan,"SELECT * FROM filmler where filmadi like '%$cumle%'");
                        ...
                        if($film_sorgu_kontrol > 0)
                        {
                            while($veriler = mysqli_fetch_array($film_sorgu))
                            {
                                ...
                                echo '
                                <div style="width: 100%; border-bottom: 1px solid black; margin-top:50px; padding-bottom:20px;">
                                    <div style="float:left; width:180px;">
                                        <img src="'.$film_resim.'" style="width:176px;height:248px;">
                                    </div>
                                <div style="float:right; width:500px;">
                                <a href="yonlendir.php?name='.$film_isim.'">
                                    <div style="font-size:26px; color: black; margin-left: -100px; margin-top: 25px;">
