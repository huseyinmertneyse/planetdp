...
else if($_GET['durum'] == 'kayit')
{
    ...
    if(isset($_POST['kayit']))
    {
        ...
        $pass = $_POST['pass'];
        $pass1 = $_POST['pass1'];
        $bul = mysqli_query($baglan,"SELECT * FROM users where kadi = '$kadi' OR email = '$email'");
    ...
    <div class="head">
        ...
        <div class="cont" style="margin-top: -40px;">
            <div style="padding-bottom: 10px;top: 0;margin-top: 4px;">
                <a href="index.php" style="padding: 0 0 12px 0;color: #fff;">Anasayfa</a>
            </div>
                    ...
                    <form method="post" action="kayit.php?durum=kayit" style="padding: 30px;">
                        <div style="padding: 15px 15px 0px 15px;">
                            <ul style="list-style: none;">
                                ...
                                <span style="display: '.$kayitvar.';"><p class="zorunlu">Bu kullanıcı adı veya email alınmıştır.</p></span>
